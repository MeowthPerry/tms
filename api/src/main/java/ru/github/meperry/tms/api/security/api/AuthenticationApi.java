...
public class AuthenticationApi extends BaseApi {
  ...
  public Mono<UserToken> login(LoginRequest loginRequest) {
    return request(HttpMethod.POST, "/api/auth/login", null, null, loginRequest, UserToken.class);
  }

  public Mono<UserToken> register(RegisterRequest registerRequest) {
    return request(HttpMethod.POST, "/api/auth/register", null, null, registerRequest, UserToken.class);
  }
}
